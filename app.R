...
ui <- fluidPage(
    ...
    tabsetPanel(
        ...
        # Another tab:
        tabPanel("Sweet Treat Showdown: Foxburry Institute (Rerun)", fluid = TRUE,
                 helpText("For those players who work on the bonus STS, I am working on the calculator for you. Stay tuned! "),
                 helpText("During this Sweet Treat Showdown event you need to collect 14400 sweet treats (48 boxes) and 168 royal cookies (24 boxes) over 11 days.
                  Therefore you need to collect on average  1309.09  sweet treats a day and 15.27  royal cookies a day to get the grand prize.
                 ...
                 sidebarLayout(
                     ...
                     mainPanel(
                         ...
                         br(),
                         #helpText("Here is more information about the event from the previous time this event was running:"),
                         helpText("Here is more information about the event:"),
                         img(src='STS_FoxburyInstitute.jpg', height=400),
                         #img(src='Charming-gardens-STS-rerun_2.png', height=400),
                         br(),
                         #tagList("Infographic Source:", a("SimmerdownMal's Reddit Post", href="https://www.reddit.com/r/SimsMobile/comments/ratqr7/updated_the_sweet_holiday_sweet_treat_showdown/"),"."),
                         ...
                         tagList("Infographic Source:", a("TheGirlWhoGames's website", href="https://thegirlwhogames.blog/2022/07/15/the-sims-mobile-jungle-rush-update/"),"."),
                         br(),
        ...
        #New Panel: 
        tabPanel("Treasure Hunt: Hallways Ready", fluid = TRUE , 
                 ...
                 sidebarLayout(
                   ...
                   sidebarPanel(
                     ...
                     checkboxInput("code1", "Row 1: Fenced Plant Pots"), 
                     checkboxInput("code2", "Row 1: Science Club Banner"), 
                     checkboxInput("code3","Row 1: Computer Lab Chair"),
                     checkboxInput("code4","Row 1: Computer Lab Table"),
                     checkboxInput("code5","Row 1: Smart Accented Polo"), 
                     checkboxInput("code6","Row 2: School Library Bookshelf"), 
                     checkboxInput("code7","Row 2: Head Teacher’s Desk"), 
                     checkboxInput("code8","Row 2: It Has Pockets!’ Skirt"),
                     checkboxInput("code9","Row 2: Cushy Inheritance Top"), 
                     checkboxInput("code10","Row 3: Dorm Single Bed with Storage"), 
                     checkboxInput("code11","Row 3: One-piece College Sofa"), 
                     checkboxInput("code12","Row 3: Status Symbol Jacket"),
                     checkboxInput("code13","Row 4: Extra Curricular Board"), 
                     checkboxInput("code14","Row 4: Bloom Shirt Pinafore"),
                   ...
                   mainPanel(
                     ...
                     img(src='TH_HallwaysReady.png', width=400), 
                     #img(src='TH_SpringFling2.png', width=400), 
                     br(),
                     tagList("Inforgraphic Source:", a("Screenshot from karenkeren's video", href="https://www.youtube.com/watch?v=uT9setmsTTA"),"."),
                     #tagList("Infographic Source:", a("SimmerdownMal's Twitter", href="https://twitter.com/simmerdownMAL/"),"."),
         ...
         tabPanel("Season Festival", fluid = TRUE , 
                 ...
                 sidebarLayout(
                     ...
                     mainPanel(
                         ...
                         img(src='SimFestival_JungleRush.png', width = 400), 
                         img(src='SimFestival_JungleRush_2.png', width = 400), 
                         img(src='SimFestival_JungleRush_3.png', width = 400), 
                         
                         #img(src='SF_SpringFling2.png', width = 400), 
                         #img(src='SF_SpringFling3.png', width = 400), 
                         br(),
                         #tagList("Infographic Source:", a("L'Univers Sims' website", href="https://wwww.luniversims.com"),"."),
                         #tagList("Infographic Source:", a("SimmerdownMal's Twitter", href="https://twitter.com/simmerdownMAL/"),"."),
                         tagList("Infographic Source:", a("Salixcat's website", href="https://www.salixcat.com"),"."),
                         #tagList("Infographic Source:", a("TheGirlWhoGames Blog", href="https://thegirlwhogames.blog/2022/05/13/the-sims-mobile-briny-nights-update/"),"."),
                         br(),
                         tagList("Huge THANKS to ", a("SimmerdownMAL", href="https://twitter.com/simmerdownMAL")," for the provided numbers of prize tickets for the tiers."),
                         br(),
                         #helpText("This app was created by Yani. If you have any questions or comments, you can contact me on Twitter: "),
                         tagList("This app was created by Yani. If you have any questions or comments, you can find me on ", a("Twitter", href="https://twitter.com/yani_tsm"),", ", a("Reddit", href="https://www.reddit.com/r/SimsMobile/"), "or most of the Sims Mobile Discord servers. Any feedback is appreciated.")
                     )
